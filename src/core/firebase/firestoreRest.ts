...
// Resource name path without the API base URL — used in commit writes where Firestore
// expects the resource name format: projects/{project}/databases/(default)/documents/...
