...
export const constitutionLabels = {
  np: {
    ...
    refresh: 'नयाँ डेटा refresh गर्नुहोस्',
    refreshing: 'नयाँ डेटा डाउनलोड हुँदैछ...',
    refreshSuccess: 'नयाँ संविधान डेटा डाउनलोड भयो।',
    refreshLimit: 'आजको manual refresh प्रयोग भइसकेको छ। भोलि फेरि प्रयास गर्नुहोस्।',
    refreshFailed: 'नयाँ डेटा डाउनलोड हुन सकेन। फेरि प्रयास गर्नुहोस्।',
  ...
  en: {
    ...
    retry: 'Retry',
    refresh: 'Refresh Constitution data',
    refreshing: 'Downloading new Constitution data...',
    refreshSuccess: 'New Constitution data downloaded.',
    refreshLimit: 'Today’s manual refresh has already been used. Please try again tomorrow.',
    refreshFailed: 'New data could not be downloaded. Please try again.',
    share: 'Share',
